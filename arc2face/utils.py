...
def project_face_embs(pipeline, face_embs):
    ...
    '''
    arcface_token_id = pipeline.tokenizer.encode("id", add_special_tokens=False)[0] # 1014
    ...
    token_embs = pipeline.text_encoder(input_ids=input_ids, return_token_embs=True)
